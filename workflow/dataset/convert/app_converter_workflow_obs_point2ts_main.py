...
TIME_RUN="2026-02-24 18:34";
TIME_PERIOD=10;

TIME_START='2026-02-06 12:00';
TIME_END='2026-02-06 19:00';

DOMAIN_NAME='PoBasin';
PATH_GEO='/home/fabio/Desktop/shybox/dset/case_study_destine/converter_hmc/geo/';
PATH_SRC='/home/fabio/Desktop/shybox/dset/case_study_destine/converter_hmc/data/obs/';
PATH_DST='/home/fabio/Desktop/shybox/exec/case_study_destine/converter_hmc/data/time_series/';
PATH_TMP=$HOME/Desktop/shybox/exec/case_study_destine/converter_hmc/tmp/;
...
from shybox.processing_points_toolkit.lib_proc_join import join_points_to_time_series
...
def main(view_table: bool = False):
    ...
    logging_handle = LoggingManager(
        name="shybox_algorithm_converter_hmc_points2ts",
    ...
    destination_data_discharge = DataLocal(
        ...
        file_type='hydrograph_hmc', file_format='ascii', file_mode='local',
    ...
    orc_process = Orchestrator.time_series_discharge(
        ...
        data_ref=registry_sections_hmc, priority=None,
