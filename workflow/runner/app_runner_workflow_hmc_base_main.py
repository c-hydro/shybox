...
PATH_RESTART=$HOME/Desktop/shybox/dset/case_study_destine/runner_hmc/restart/ifs/;
PATH_SRC=$HOME/Desktop/shybox/dset/case_study_destine/runner_hmc/data/ifs/;
...
def main(view_table: bool = False, dry_run : bool = False):
    ...
    alg_cfg_time = TimeManager.from_config(
        alg_cfg_obj, start_days_before=0, time_priority='run',
