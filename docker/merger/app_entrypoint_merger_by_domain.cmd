...
DOCKER_BUILDKIT=1 docker build --no-cache --progress=plain -f Dockerfile --target app-merger -t merger:dev .

# docker build converter [ONLY CONVERTER]
DOCKER_BUILDKIT=1 docker build --progress=plain -f Dockerfile --target app-merger -t merger:dev .
## --------------------------------------------------------------------------------------------------
