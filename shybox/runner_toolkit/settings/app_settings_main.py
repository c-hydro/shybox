#!/usr/bin/python3
"""
SHYBOX - Snow HYdro toolBOX - RUNNER SETTINGS APP
...
from shybox.generic_toolkit.lib_default_args import logger_name, logger_format
...
project_name = 'shybox'
alg_name = 'runner - settings application'
alg_type = 'package'
alg_version = '1.0.0'
