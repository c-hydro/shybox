...
class OrchestratorPoints(OrchestratorBase):
    ...
    def points(
        ...
        logger = logger or LoggingManager(name="OrchestratorPoints")

        # info orchestrator start
        logger.info_up('Organize orchestrator [points] ...', tag="ow")
        ...
        logger.info_down('Organize orchestrator [points] ... DONE', tag="ow")
