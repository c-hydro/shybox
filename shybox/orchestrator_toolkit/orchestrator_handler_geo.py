...
class OrchestratorGeo(OrchestratorBase):
    ...
    def watersheds(
        ...
        logger = logger or LoggingManager(name="OrchestratorGeo")

        # info orchestrator start
        logger.info_up('Organize orchestrator [geo] ...', tag="ow")
        ...
        logger.info_down('Organize orchestrator [geo] ... DONE', tag="ow")
