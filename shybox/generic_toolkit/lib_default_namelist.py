...
# Namelist constants
structure_namelist_hmc_330 = dict(
    ...
    HMC_Info={
        'sReleaseVersion': "3.3.0",     # 3.3.0
        'sAuthorNames': "Delogu F., Silvestro F., Gabellani S., Libertino A., Ercolani G.",
        'sReleaseDate': "2025/11/14",
    },
)